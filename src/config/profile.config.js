...
export const profileConfig = {
   ...
   */
  skills: [
    { name: 'Python', label: 'PYTHON', value: 92, type: 'hp' },
    { name: 'PyTorch / 深度学习', label: 'PYTORCH', value: 85, type: 'hp' },
    { name: 'LLM 应用开发', label: 'LLM APPS', value: 88, type: 'hp' },
    { name: 'Computer Vision', label: 'CV', value: 80, type: 'mp' },
    { name: 'Web 前端 (React)', label: 'FRONTEND', value: 70, type: 'mp' },
    { name: 'Rust / Tauri', label: 'RUST', value: 55, type: 'mp' },
    { name: '游戏与二次元浓度', label: 'ACG LV.', value: 99, type: 'exp' },
  ],
