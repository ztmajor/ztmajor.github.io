...
const dscoder = {
  ...
  blocks: [
    ...
    {
      type: 'paragraph',
      text: '每天高强度使用 DSH（DeepSeek Harness），爽是真爽，但启动方式一直让我有点难受——每次想用的时候，都得在不同设备上打开终端，敲一串命令，等它慢慢起来。换设备就得再来一遍，活像在搞某种命令行仪式。去社区找现成的桌面套壳方案，发现很多项目确实能用，但普遍集成了大量我用不上的插件，不够清爽。',
    },
    {
      type: 'paragraph',
